...
const Profile = () => {
  ...
  const familyData = [
    { id: '1', name: 'Robert Fox', relation: 'Father', image: imagePaths.profilepic },
    { id: '2', name: 'Guy Hawkins', relation: 'Mother', image: imagePaths.profilepic },
    { id: '3', name: 'Jenny Wilson', relation: 'Wife', image: imagePaths.profilepic },
    { id: '4', name: 'Jenny Wilson', relation: 'Wife', image: imagePaths.profilepic },
  ];
