...
import { View, Text, TouchableOpacity, StyleSheet, FlatList, Image, SectionList } from 'react-native';
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.buttonContainer}>
                ...
                <TouchableOpacity
                    style={[styles.tabButton, activeTab === 'resident' && styles.activeTab]}
                    onPress={() => setActiveTab('resident')}>
                    <Text style={[styles.tabText, activeTab === 'resident' && styles.activeTabText]}>Residents</Text>
                </TouchableOpacity>
            </View>
