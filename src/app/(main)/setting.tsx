...
import { Ionicons } from '@expo/vector-icons'; // Add Ionicons for each item
...
const SettingsScreen = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity style={styles.itemBox} onPress={() => navigation.navigate('editprofile')}>
                <Ionicons name="person-outline" size={24} color="gray" style={styles.icon} />
                <Text style={styles.itemText}>Edit Profile</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.itemBox} onPress={() => navigation.navigate('language')}>
                <Ionicons name="language-outline" size={24} color="gray" style={styles.icon} />
                <Text style={styles.itemText}>Language</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.itemBox} onPress={() => navigation.navigate('getsupport')}>
                <Ionicons name="help-circle-outline" size={24} color="gray" style={styles.icon} />
                <Text style={styles.itemText}>Get Support</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.itemBox} onPress={() => navigation.navigate('terms')}>
                <Ionicons name="document-text-outline" size={24} color="gray" style={styles.icon} />
                <Text style={styles.itemText}>Terms & Condition</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.itemBox} onPress={() => navigation.navigate('policy')}>
                <Ionicons name="shield-checkmark-outline" size={24} color="gray" style={styles.icon} />
                <Text style={styles.itemText}>Privacy Policy</Text>
            </TouchableOpacity>

            <TouchableOpacity style={[styles.itemBox, styles.logoutItem]} onPress={() => setIsModalVisible(true)}>
